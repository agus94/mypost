  ...
  <div class="box">
    ...
    <div class="box-body">
       <?php 
        ...
        <?= $row->barcode;?>
        <br><br>
        <a href="<?= site_url('item/barcode_print/'.$row->item_id); ?>" target="blank" class="btn btn-default btn-sm">
    ...
    <div class="box">
      ...
      ?>
        <img src="<?= base_url('uploads/qr-code/item-'.$row->item_id.'.png') ?>" alt="" style="width:200px">
        <br>
        <?= $row->barcode;?>
        <br><br>
        <a href="<?= site_url('item/qrcode_print/'.$row->item_id); ?>" target="blank" class="btn btn-default btn-sm">
            <i class="fa fa-print"></i>Print
        </a>
    </div>
    </div>
